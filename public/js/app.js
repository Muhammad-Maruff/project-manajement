...
var checkIconContainer = document.querySelector('.checkIconContainer');
var saveEditProfile = document.querySelector('.saveEditProfile');
...
function toggleEditMode() {
  ...
  elements.forEach(function (element) {
    var displayElem = document.getElementById(element.display);
    var inputElem = document.getElementById(element.input);
  ...
  fetch('/profile/update', {
    ...
    if (data.success) {
      ...
      Swal.fire({
        ...
        footer: '<ul>' + Object.values(data.errors).map(function (errors) {
          return "<li>".concat(errors[0], "</li>");
        }).join('') + '</ul>',
        showConfirmButton: true,
        customClass: {
          popup: 'custom-swal-popup',
